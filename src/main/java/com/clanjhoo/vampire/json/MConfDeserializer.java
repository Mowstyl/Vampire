...
public class MConfDeserializer implements JsonDeserializer<MConf> {
    ...
    public MConfDeserializer(VampireRevamp plugin) {
        this.plugin = plugin;
    }
    ...
    public MConf deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
        ...
        if (jsonElement.isJsonObject()) {
            ...
            Type setEntityType = new TypeToken<Set<EntityType>>(){}.getType();
            ...
            mConf.setAliasesVampireModeBatusi(root.has("aliasesVampireModeBatusi") ?
                                                    gson.fromJson(root.getAsJsonArray("aliasesVampireModeBatusi"), listStringType) :
                                                    CollectionUtil.list("batusi"));
            ...
            mConf.setAliasesVampireSetNosferatu(root.has("aliasesVampireSetNosferatu") ?
                                                gson.fromJson(root.getAsJsonArray("aliasesVampireSetNosferatu"), listStringType) :
                                                CollectionUtil.list("nosferatu", "n"));
            ...
            */
            ...
            mConf.setTruceEntityTypes(gson.fromJson(root.getAsJsonArray("truceEntityTypes"), setEntityType));
            ...
            mConf.setSunStopEffectsTemp(root.has("sunStopEffectsTemp") ? root.get("sunStopEffectsTemp").getAsDouble() : 0.65D);
            ...
            AltarDark ad = new AltarDark(this.plugin);
            AltarLight al = new AltarLight(this.plugin);
