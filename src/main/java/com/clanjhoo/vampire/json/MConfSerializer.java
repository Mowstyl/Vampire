...
public class MConfSerializer implements JsonSerializer<MConf> {
    ...
    public JsonElement serialize(MConf mConf, Type type, JsonSerializationContext jsonSerializationContext) {
        ...
        root.add("aliasesVampireModeBatusi", gson.toJsonTree(mConf.getAliasesVampireModeBatusi()).getAsJsonArray());
        ...
        root.add("aliasesVampireSetNosferatu", gson.toJsonTree(mConf.getAliasesVampireSetNosferatu()).getAsJsonArray());
        ...
        root.addProperty("sunStopEffectsTemp", mConf.getSunStopEffectsTemp());
