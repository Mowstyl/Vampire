...
public class PluginConfig {
    ...
    private boolean saveConfigToFile(BufferedWriter configWriter, String indent, int level) {
        boolean result = writeLine(configWriter, "general:", indent, level);
    ...
    public PluginConfig(FileConfiguration config) {
        ...
        Map<EntityType, Double> auxffq = null;
        if (config.contains("fullFoodQuotient")) {
            List<Map<?, ?>> auxLES = config.getMapList("buildMaterials");
            auxffq = new HashMap<>();
        ...
        fullFoodQuotient = auxffq != null ? auxffq : def.fullFoodQuotient;
